...
#ifndef mitkAdaptiveTumorSegTool_h_Included
#define mitkAdaptiveTumorSegTool_h_Included
...
namespace mitk
{
  ...
  /**
  \brief Dummy Tool for AdaptiveTumorSegToolGUI to get Tool functionality for AdaptiveTumorSeg.
  The actual logic is implemented in QmitkAdaptiveTumorSegToolGUI.
  ...
  */
  class MITKSEGMENTATION_EXPORT AdaptiveTumorSegTool : public AutoSegmentationTool
  {
  public:
     ...
     */
    mitkClassMacro(AdaptiveTumorSegTool, AutoSegmentationTool);
  ...
  protected:
     ...
     * @brief constructor
     */
    AdaptiveTumorSegTool(); // purposely hidden

    /**
     * @brief destructor
     */
    virtual ~AdaptiveTumorSegTool();
