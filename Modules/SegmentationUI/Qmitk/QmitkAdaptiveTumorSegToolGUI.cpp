...
===================================================================*/
#include "QmitkAdaptiveTumorSegToolGUI.h"
...
MITK_TOOL_GUI_MACRO( , QmitkAdaptiveTumorSegToolGUI, "")

QmitkAdaptiveTumorSegToolGUI::QmitkAdaptiveTumorSegToolGUI(QWidget* parent)
  : QmitkToolGUI(),
...
QmitkAdaptiveTumorSegToolGUI::~QmitkAdaptiveTumorSegToolGUI()
{
...
void QmitkAdaptiveTumorSegToolGUI::OnNewToolAssociated(mitk::Tool* tool)
{
  m_RegionGrow3DTool = dynamic_cast<mitk::AdaptiveTumorSegTool*> (tool);
  if(m_RegionGrow3DTool.IsNotNull())
  {
    ...
    itk::SimpleMemberCommand<QmitkAdaptiveTumorSegToolGUI>::Pointer pointAddedCommand = itk::SimpleMemberCommand<QmitkAdaptiveTumorSegToolGUI>::New();
    pointAddedCommand->SetCallbackFunction(this, &QmitkAdaptiveTumorSegToolGUI::OnPointAdded);
...
void QmitkAdaptiveTumorSegToolGUI::RemoveHelperNodes()
{
...
void QmitkAdaptiveTumorSegToolGUI::CreateConnections()
{
...
void QmitkAdaptiveTumorSegToolGUI::SetDataNodeNames(std::string labledSegmentation, std::string binaryImage, std::string surface, std::string maskedSegmentation )
{
...
void QmitkAdaptiveTumorSegToolGUI::SetDataStorage(mitk::DataStorage* dataStorage)
{
  m_DataStorage = dataStorage;
}

void QmitkAdaptiveTumorSegToolGUI::SetMultiWidget(QmitkStdMultiWidget* multiWidget)
{
  m_MultiWidget = multiWidget;
}

void QmitkAdaptiveTumorSegToolGUI::SetInputImageNode(mitk::DataNode* node)
{
...
void QmitkAdaptiveTumorSegToolGUI::OnPointAdded()
{
  ...
  if (node != NULL)
  {
      ...
      if (pointSet.IsNull())
      {
          QMessageBox::critical(NULL, "QmitkAdaptiveTumorSegToolGUI", "PointSetNode does not contain a pointset");
          return;
      }
      ...
      for (auto & pixelValue : pixelValues)
      {
        ...
        {
          m_SeedPointValueMean = (pixelValue > m_SeedPointValueMean) ? pixelValue :  m_SeedPointValueMean;
        }
      }
      ...
      */
      ...
      {
        m_LOWERTHRESHOLD = m_SeedPointValueMean * 0.4;
...
void QmitkAdaptiveTumorSegToolGUI::RunSegmentation()
{
...
void QmitkAdaptiveTumorSegToolGUI::StartRegionGrowing(itk::Image<TPixel, VImageDimension>* itkImage, mitk::BaseGeometry* imageGeometry, mitk::PointSet::PointType seedPoint)
{
  ...
  if(m_CurrentRGDirectionIsUpwards)
  {
    m_Controls.m_PreviewSlider->setValue(m_UPPERTHRESHOLD);
  }
  else
  {
    m_Controls.m_PreviewSlider->setValue(m_UPPERTHRESHOLD);
...
void QmitkAdaptiveTumorSegToolGUI::InitializeLevelWindow()
{
...
void QmitkAdaptiveTumorSegToolGUI::ChangeLevelWindow(double newValue)
{
...
void QmitkAdaptiveTumorSegToolGUI::DecreaseSlider()
{
...
void QmitkAdaptiveTumorSegToolGUI::IncreaseSlider()
{
...
void QmitkAdaptiveTumorSegToolGUI::ConfirmSegmentation()
{
  //get image node
  if(m_InputImageNode.IsNull())
  {
...
template<typename TPixel, unsigned int VImageDimension>
void QmitkAdaptiveTumorSegToolGUI::ITKThresholding(itk::Image<TPixel, VImageDimension>* itkImage)
{
...
void QmitkAdaptiveTumorSegToolGUI::EnableControls(bool enable)
{
  if (m_RegionGrow3DTool.IsNull())
    return;
...
void QmitkAdaptiveTumorSegToolGUI::EnableVolumeRendering(bool enable)
{
...
void QmitkAdaptiveTumorSegToolGUI::UpdateVolumeRenderingThreshold(int thValue)
{
...
void QmitkAdaptiveTumorSegToolGUI::UseVolumeRendering(bool on)
{
...
void QmitkAdaptiveTumorSegToolGUI::SetLowerThresholdValue( double lowerThreshold )
{
  m_LOWERTHRESHOLD = lowerThreshold;
}

void QmitkAdaptiveTumorSegToolGUI::SetUpperThresholdValue( double upperThreshold)
{
  m_UPPERTHRESHOLD = upperThreshold;
}

void QmitkAdaptiveTumorSegToolGUI::Deactivated()
{
...
void QmitkAdaptiveTumorSegToolGUI::Activated()
{
}
