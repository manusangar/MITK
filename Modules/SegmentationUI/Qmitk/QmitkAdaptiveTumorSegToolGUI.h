...
===================================================================*/
#ifndef QMITK_QmitkAdaptiveTumorSegToolGUI_H
#define QMITK_QmitkAdaptiveTumorSegToolGUI_H
...
#include "qwidget.h"
#include "ui_QmitkAdaptiveTumorSegToolGUIControls.h"
...
class DataNode;
class QmitkAdaptiveTumorSegToolGUIControls;
...
class MITKSEGMENTATIONUI_EXPORT QmitkAdaptiveTumorSegToolGUI : public QmitkToolGUI
{
...
public:
   ...
   */
  mitkClassMacro(QmitkAdaptiveTumorSegToolGUI, QmitkToolGUI);

  itkFactorylessNewMacro(Self)
  itkCloneMacro(Self)

  QmitkAdaptiveTumorSegToolGUI(QWidget* parent=0);
  ...
  */
  Ui::QmitkAdaptiveTumorSegToolGUIControls m_Controls;
...
protected:
  ...
  mitk::AdaptiveTumorSegTool::Pointer m_RegionGrow3DTool;

  /** \brief Destructor. */
  virtual ~QmitkAdaptiveTumorSegToolGUI();
