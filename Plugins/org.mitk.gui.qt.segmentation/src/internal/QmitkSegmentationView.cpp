...
void QmitkSegmentationView::CreateQtPartControl(QWidget* parent)
{
   ...
   m_Controls->m_ManualToolSelectionBox3D->SetDisplayedToolGroups("Threshold 'UL Threshold' Otsu 'Fast Marching 3D' 'Region Growing 3D' 'Tumor Segmentation 3D' Watershed 'Body Detection' Picking");
